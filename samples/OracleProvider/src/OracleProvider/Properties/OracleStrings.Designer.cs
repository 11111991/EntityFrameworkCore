...
namespace Microsoft.EntityFrameworkCore.Internal
{
    ...
    public static class OracleStrings
    {
        ...
        /// <summary>
        ///     No type was specified for the decimal column '{property}' on entity type '{entityType}'. This will cause values to be silently truncated if they do not fit in the default precision and scale. Explicitly specify the SQL server column type that can accomadate all the values using 'ForOracleHasColumnType()'.
        /// </summary>
        ...
        public static readonly EventDefinition<string, string> LogForeignKeyTableNotInSelectionSet
            = new EventDefinition<string, string>(
                OracleEventId.ForeignKeyTableMissingWarning,
                LogLevel.Debug,
                LoggerMessage.Define<string, string>(
                    LogLevel.Debug,
                    OracleEventId.ForeignKeyTableMissingWarning,
