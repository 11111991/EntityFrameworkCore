...
";
        ...
        public class BuiltInDataTypesOracleFixture : BuiltInDataTypesFixtureBase
        {
            ...
            protected override void OnModelCreating(ModelBuilder modelBuilder, DbContext context)
            {
                ...
                modelBuilder.Entity<MappedDataTypes>(e
                    =>
                    {
                ...
                modelBuilder.Entity<MappedNullableDataTypes>(e
                    =>
                    {
                        e.Property(m => m.Bigint).HasColumnType("NUMBER(19)");
                        e.Property(m => m.Tinyint).HasColumnType("NUMBER(3)");
                ...
                modelBuilder.Entity<MappedSizedDataTypes>(e
                    =>
                    {
                ...
                modelBuilder.Entity<MappedScaledDataTypes>(e
                    =>
                    {
                        e.Property(m => m.Datetimeoffset).HasColumnType("TIMESTAMP WITH TIME ZONE");
                ...
                modelBuilder.Entity<MappedDataTypesWithIdentity>(e
                    =>
                    {
                        e.Property(m => m.Bigint).HasColumnType("NUMBER(19)");
                        e.Property(m => m.Tinyint).HasColumnType("NUMBER(3)");
                ...
                modelBuilder.Entity<MappedNullableDataTypesWithIdentity>(e
                    =>
                    {
                        e.Property(m => m.Bigint).HasColumnType("NUMBER(19)");
                        e.Property(m => m.Tinyint).HasColumnType("NUMBER(3)");
                ...
                modelBuilder.Entity<MappedSizedDataTypesWithIdentity>(e
                    =>
                    {
                        e.Property(m => m.Binary).HasColumnType("RAW(3)");
                        e.Property(m => m.Varbinary).HasColumnType("RAW(3)");
                ...
                modelBuilder.Entity<MappedScaledDataTypesWithIdentity>(e
                   =>
                   {
