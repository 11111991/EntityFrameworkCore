...
{
    public class OracleDatabaseModelFactoryTest : IClassFixture<OracleDatabaseModelFactoryTest.OracleDatabaseModelFixture>
    {
        protected OracleDatabaseModelFixture Fixture { get; }

        public OracleDatabaseModelFactoryTest(OracleDatabaseModelFixture fixture) => Fixture = fixture;

        #region Sequences

        [ConditionalFact]
        [OracleCondition(OracleCondition.SupportsSequences)]
...
DROP TABLE [db.2].[K2];");
        ...
        [ConditionalFact]
        [OracleCondition(OracleCondition.SupportsMemoryOptimized)]
                ...
                dbModel =>
                    {
                        ...
                        // ReSharper disable once PossibleNullReferenceException
                        Assert.True((bool)table[OracleAnnotationNames.MemoryOptimized]);
                    },
                @"DROP TABLE [Blogs]");
        }
                ...
                dbModel =>
                    {
                        ...
                        Assert.Null(pk[OracleAnnotationNames.Clustered]);
                ...
                dbModel =>
                    {
                        ...
                        Assert.Null(uniqueConstraint[OracleAnnotationNames.Clustered]);
...
CREATE TABLE NullableColumns (
    ...
    NonNullString nvarchar(max) NOT NULL,
        ...
        [ConditionalFact]
        [OracleCondition(OracleCondition.SupportsHiddenColumns)]
                ...
                dbModel =>
                    {
                        ...
                        Assert.False((bool)pk[OracleAnnotationNames.Clustered]);
                ...
                dbModel =>
                    {
                        ...
                        Assert.True((bool)uniqueConstraint[OracleAnnotationNames.Clustered]);
                ...
                dbModel =>
                    {
                        ...
                        Assert.True((bool)index[OracleAnnotationNames.Clustered]);
                ...
                dbModel =>
                    {
                        ...
                        Assert.Equal(OracleStrings.LogMissingSchema.EventId, warning.Id);
                        Assert.Equal(OracleStrings.LogMissingSchema.GenerateMessage("MySchema"), warning.Message);
                    },
                @"DROP TABLE Blank;");
        }
                ...
                dbModel =>
                    {
                        ...
                        Assert.Equal(OracleStrings.LogMissingTable.EventId, warning.Id);
                        Assert.Equal(OracleStrings.LogMissingTable.GenerateMessage("MyTable"), warning.Message);
                    },
                @"DROP TABLE Blank;");
        }
                ...
                dbModel =>
                    {
                        ...
                        Assert.Equal(OracleStrings.LogPrincipalTableNotInSelectionSet.EventId, warning.Id);
                        Assert.Equal(OracleStrings.LogPrincipalTableNotInSelectionSet.GenerateMessage("MYFK", "dbo.DependentTable", "dbo.PrincipalTable"), warning.Message);
                    },
                @"
DROP TABLE DependentTable;
DROP TABLE PrincipalTable;");
        ...
        private void Test(string createSql, IEnumerable<string> tables, IEnumerable<string> schemas, Action<DatabaseModel> asserter, string cleanupSql)
        {
            ...
            try
            {
                var databaseModelFactory = new OracleDatabaseModelFactory(
        ...
        public class OracleDatabaseModelFixture : SharedStoreFixtureBase<DbContext>
        {
            protected override string StoreName { get; } = nameof(OracleDatabaseModelFactoryTest);
            protected override ITestStoreFactory TestStoreFactory => OracleTestStoreFactory.Instance;
            public new OracleTestStore TestStore => (OracleTestStore)base.TestStore;

            public OracleDatabaseModelFixture()
            {
