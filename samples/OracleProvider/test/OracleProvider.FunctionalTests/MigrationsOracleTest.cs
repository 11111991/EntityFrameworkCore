...
{
    public class MigrationsOracleTest : MigrationsTestBase<MigrationsOracleFixture>
    {
        public MigrationsOracleTest(MigrationsOracleFixture fixture)
            : base(fixture)
        {
        }
...
",
        ...
        public override void Can_get_active_provider()
        {
            ...
            Assert.Equal("Microsoft.EntityFrameworkCore.Oracle", ActiveProvider);
        }
...
",
        ...
        public async Task Empty_Migration_Creates_Database()
        {
            ...
            {
                var creator = (OracleDatabaseCreator)context.GetService<IRelationalDatabaseCreator>();
